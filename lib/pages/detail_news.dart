                        ...
                        Column(
                          ...
                          children: [
                            ...
                            const Padding(
                              ...
                              child: Text(
                                'KOMPAS.com – Penggunaan mobil listrik, khususnya hybrid, di Indonesia terus mengalami peningkatan seiring tingginya kesadaran masyarakat akan pentingnya menjaga lingkungan dan mengurangi emisi gas buang. Berdasarkan data Gabungan Industri Kendaraan Bermotor Indonesia (Gaikindo), mobil hybrid, baik itu hybrid electric vehicle (HEV) maupun plug-in hybrid electric vehicle (PHEV), masih mendominasi pasar mobil listrik di Indonesia pada 2023. Hal tersebut terlihat dari tingginya angkanya penjualan mobil Hybrid 41.571 unit atau 77,8 persen dari total penjualan kendaraan listrik keseluruhan pada periode Januari hingga Oktober 2023. Dari jajaran kendaraan hybrid, PT Toyota Astra Mandiri (TAM) masih memimpin penjualan pada sektor itu dengan capaian 29.183 unit. Keberhasilan Toyota dalam memimpin persaingan di pasar kendaraan hybrid pun disinyalir berkat kualitas produk kendaraan yang mereka hasilkan. Apa saja kendaraan hybrid dari Toyota tersebut? Berikut adalah ulasannya\n\nArtikel ini telah tayang di Kompas.com dengan judul \"Jadi Penguasa Pasar, Ini Deretan Kendaraan Hybrid dari Toyota\", Klik untuk baca: https://otomotif.kompas.com/read/2023/11/28/082100415/jadi-penguasa-pasar-ini-deretan-kendaraan-hybrid-dari-toyota.\n\n\nKompascom+ baca berita tanpa iklan: https://kmp.im/plus6\nDownload aplikasi: https://kmp.im/app6',
                                style: TextStyle(
                                    fontFamily: "Readex",
                                    fontSize: 16,
